...
function save_comment(path, board_idx, user_nickname) {
	...
	$.ajax({
		...
		success : function(return_data) {
			...
			$(".empty_comment_div:last").replaceWith("<div class = 'comment_div form-group'>" + 
...
function modify_board_comment(my_value, path, comment_text, writer_idx) {
	...
	my_value.parent().replaceWith("<div align = 'right'>" + 
			"<button type = 'button' class = 'btn btn-primary' onclick = 'modify_board_comment_confirm($(this), " + writer_idx + ", " + path + ")'>확인</button>&nbsp;" + 
			"<button type = 'button' class = 'btn btn-danger' onclick = 'cancleCommentModification($(this),\"" + comment_text + "\")'>취소</button>&nbsp;" + 
			"</div>");
}
...
function cancleCommentModification(my_value, comment_text) {
	my_value.parent().prev().prev().replaceWith("<div class = 'form-control'>" + comment_text + "</div>");
	my_value.parent().replaceWith("<div align = 'right'>" + 
			"<button type = 'button' class = 'btn btn-warning'>삭제</button>&nbsp;" + 
			"<button type = 'button' class = 'btn btn-info'>수정</button>&nbsp;" + 
			"<button type = 'button' class = 'btn btn-primary'>답글달기</button>&nbsp;" + 
			"</div>")
}