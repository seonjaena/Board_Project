 ...
 * 
 */
function checkUserNickExist(path) {
	...
	$.ajax({
		url : path + "user/checkUserNickNameExist?user_nickname=" + user_nickname,
		type : "GET", 
		dataType : "text", 
...
function checkUserIdExist(path) {
	...
	$.ajax({
		url : path + "user/checkUserIdExist?user_id=" + user_id,
		type : "GET", 
		dataType : "text", 
		success : function(result) {
			if(result.trim() == "true") {
